...
./configure --prefix=/usr/local --with-axis2=/usr/include/axis2-1.6.0 --with-apache2=/usr/include/apache2 --with-apr=/usr/include/apr-1.0 --enable-libxml2 --disable-wsclient
make -j 10 
# make install
# make examples
