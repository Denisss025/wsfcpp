...
void AXIS2_CALL
libntlm_wrapper_free(
    axis2_ntlm_t * ntlm,
    const axutil_env_t * env);

axis2_status_t AXIS2_CALL
libntlm_wrapper_create_type1_message(
    axis2_ntlm_t * ntlm,
    const axutil_env_t * env,
...
axis2_status_t AXIS2_CALL
libntlm_wrapper_create_type3_message(
    axis2_ntlm_t * ntlm,
    const axutil_env_t * env,
...
typedef struct libntlm_wrapper_impl_t
{
    axis2_ntlm_t ntlm;

    /*xmlTextReaderPtr reader;*/

} libntlm_wrapper_impl_t;

#define AXIS2_INTF_TO_IMPL(p) ((libntlm_wrapper_impl_t*)p)
...
axis2_ntlm_create(
    const axutil_env_t *env)
{
    libntlm_wrapper_impl_t *wrapper_impl = NULL;
    wrapper_impl = (libntlm_wrapper_impl_t *)AXIS2_MALLOC(env->allocator,
        sizeof(libntlm_wrapper_impl_t));
    ...
    memset(wrapper_impl, 0, sizeof(libntlm_wrapper_impl_t));
    /*wrapper_impl->x=NULL;*/
